...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 2080, host: 2080, host_ip: "127.0.0.1", id: "http"
  config.vm.network "forwarded_port", guest: 2443, host: 2443, host_ip: "127.0.0.1", id: "https"
